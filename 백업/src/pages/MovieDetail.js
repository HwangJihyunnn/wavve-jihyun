      ...
      <Row className='detail_section'>
        ...
        <Col lg={6} className='detail-info-group'>
          ...
          <div className='detail-info'>
            ...
            {showDetail?.abult? "19+":"Under 18"}
            </div>
          </div>
          <hr/>
          <div className="detail-info2">
            <div>
              <Badge bg='danger' text="dart">Realse Date</Badge>
              {showDetail?.release_date}
            </div>
            <div>
              <Badge bg='danger' text="dart">runtime</Badge>
              {showDetail?.vote_average}
            </div>
            <div>
              <Badge bg='light' text="dark">populartiy</Badge>
              {showDetail?.populartiy}
            </div>
          </div>
          <div>
            <Video/>
